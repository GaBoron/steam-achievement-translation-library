...
2. Upload the uncompressed `UserGameStatsSchema_<app_id>.bin` directly. The app ID in the filename must match the form.
3. Automation checks the form, filename, Binary KeyValues parsing, byte-identical roundtrip, achievement records, and unique achievement IDs.
